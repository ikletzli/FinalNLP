...
class SortDataset(Dataset):
    ...
    def __init__(self, split, length=6, num_digits=3, seed=42, full_size = 1000):
...
class LitGPT(L.LightningModule):
    def __init__(self, model_config, data_length, linear_replacer = None,):
        super().__init__()
...
def eval_split(model, trainer, train_dataset, test_dataset, split, max_batches):
    model.eval()
